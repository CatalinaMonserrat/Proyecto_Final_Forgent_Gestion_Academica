...
SECRET_KEY = 'django-insecure-xngkro&bc)qy))jz5(2lh+8upgzu_7yy*6wh(vt8*ch&luge4z'
...
ROOT_URLCONF = 'forgent_gestion_academica.urls'
...
WSGI_APPLICATION = 'forgent_gestion_academica.wsgi.application'
